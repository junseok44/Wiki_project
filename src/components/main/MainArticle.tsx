  ...
  return (
        ...
        <div>
          ...
          <ArticleBlock title="개요" indexId="1.1">
            ...
            같은 편안한 곡들로 인해 소프트한 밴드로 인식하기 쉽지만 실제로
            공연에 가보면 엄청 시끄럽고 강력한 록밴드 그 자체이다.
          </ArticleBlock>
          ...
          <ArticleBlock title="결성과 데뷔" indexId="2.1">
            ...
            개명하였으나, 블루 하츠의 노래 '人にやさしく'에 충격을 받은
            마사무네는 곧 한계를 느끼고 활동을 중단하였다. 그 후 쿠사노
            마사무네가 도쿄조형대학을 중퇴하고 무사시노미술대학에 입학하였으나,
            그후에도 타무라의 교류는 지속하였다. 그러던 중 타무라가 소꿉친구
            미와 테츠야를 초대하고 미와가 같은 동아리의 드러머 사키야마 타츠오를
            영입하면서 마사무네와 함께 4인조 체제의 'Spitz'를 결성하였고, 도쿄
            일대의 라이브 하우스에서 공연을 하면서 밴드 생활을 이어나갔다.
            초기에는 아직 블루하츠의 영향력에서 벗어나지 못한 모습을 보였으나,
            곧 밴드 자체적으로 한계를 느끼고 포크 스타일의 음악으로 전향하였다.
            그후 점점 이름을 알려나가다 1990년 미니앨범 'ヒバリのこころ(종달새의
            마음)'를 발매하며 인디즈로 데뷔하고, 1991년 폴리도르 레코드에서 1집
            'スピッツ(스핏츠)'와 싱글 'ヒバリのこころ(종달새의 마음)'을
            발매하면서 정식으로 메이저 데뷔하였다.
          </ArticleBlock>
          <ArticleBlock title="현재" indexId="2.2">
            ...
            아이노리 주제가들은 모두 오리콘 차트 1위를 차지했었기에,[8]
            마사무네는 '1위 기록을 깨서 죄송하네요'라고 말할 정도로 압박감이
            있었다고 말했었지만, 스칼렛 싱글 이후 간만에 오리콘 1위를 차지하면서
            히트에 성공한다.[9] 이후 발매한 B-SIDE 앨범 色色衣와 11집 앨범
            スーベニア 앨범도 안정적인 판매량을 기록하였고, 이 시기부터의
            스핏츠는 안정기에 접어들게 된다. 스베니아 앨범 이후 さざなみCD,
            とげまる 앨범까지 한결같이 좋은 음악성을 선보이면서 대중과 골수 팬들
            양쪽의 지지를 고르게 얻는데 성공해냈다. 다만 일부 팬들의 경우 카메다
            세이지 프로듀싱 이후 스타일이 정형화되었다고 불만을 가지기도 하지만,
            사실 스핏츠 음악은 (하야부사 시절을 제외하면) 로빈손 이후부터
            한결같았다(...). 2013년, 2010년 이후 3년 간의 공백을 깨고 싱글
            'さらさら(졸졸)'／'僕はきっと旅に出る(나는 여행을 떠날 거야)'를
            발표하였으며[10], 2013년 9월 11일 정규 14집 '小さな生き物'를
            발표했다. 발매 첫날 3만 7천장을 팔아치우면서 건재함을 과시하는 중.
            2015년 4월 15일에 아이튠스와 다운로드 사이트 '레코쵸크'를 통해
            '雪風(눈바람)'를 발표했다. '雪風'는 텔레비젼 도쿄 계열 드라마
            '不便な便利屋(불편한 심부름센터)'의 엔딩 테마로 쓰였다. 2016년 4월
            27일 새 싱글 'みなと'를 발표했다. 발매 전에 NTT 동일본의 CM
            いっしょに、一生懸命に。에 삽입되었다. 이 후 같은 해 7월 27일에 신보
            '醒めない'가 발매 될 것임을 발표하였다. 신보 醒めない는 주간
            순위에서는 2위를 기록하였지만 총 판매량은 전작을 이미 뛰어넘었고,
            발매 3달이 지난 10월 시점까지 차트에서 1000장대를 유지하고 있다.
          </ArticleBlock>
